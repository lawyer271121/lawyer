    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=256, verbose_name='title_gallery')),
                ('details', models.TextField(verbose_name='details_gallery')),
                ('photo', models.ImageField(blank=True, null=True, upload_to='images/', verbose_name='photo_gallery')),
            ],
            options={
                'db_table': 'gallery',
                'ordering': ['dateg'],
        ...
        migrations.AddIndex(
            model_name='gallery',
            index=models.Index(fields=['dateg'], name='gallery_dateg_b4e795_idx'),
        ),
        migrations.AddField(
            model_name='answers',
            name='specialist',
